...
namespace LaboratorioExame.Controllers
{
    public class CidadeController : Controller
    {
        ...
        {
            ViewData["EstadoId"] = new SelectList(_context.Estado, "EstadoId", "EstadoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CidadeId,CidadeNome,EstadoId")] Cidade cidade)
        {
            ...
            ViewData["EstadoId"] = new SelectList(_context.Estado, "EstadoId", "EstadoNome", cidade.EstadoId);
            return View(cidade);
        }
        ...
        {
          return (_context.Cidade?.Any(e => e.CidadeId == id)).GetValueOrDefault();
        }
    }
}
